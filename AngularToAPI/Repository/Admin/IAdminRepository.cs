...
namespace AngularToAPI.Repository.Admin
{
    public interface IAdminRepository
    {
        ...
        Task<IEnumerable<RolePermission>> GetRolePermissionAsync(string id);
        Task<RolePermission> GetRowRolePermission(string RoleId, int componentId);
        Task<IEnumerable<RolePermission>> InsertRolePermissionAsync(IEnumerable<RolePermission> LtsrolePermission);

        Microsoft.AspNetCore.Mvc.IActionResult GetActorBy_Procedures();

        Task<IEnumerable<RolePermission>> GetRolePermission_ProceduresAsync(string RoleId);
